 ...
 * @return Current register value.
 */
uint16_t INA219_ReadPower_mW(INA219_t *ina219)
{
    uint16_t result = INA219_ReadDataForRegister_16Bits(ina219, INA219_REG_POWER);
...
{
    uint16_t configInfo = INA219_CONFIG_VOLTAGE_RANGE_16V | INA219_CONFIG_GAIN_2_80MV |
                          INA219_CONFIG_BADCRES_12BIT_128S_69MS | INA219_CONFIG_SADCRES_12BIT_128S_69MS |
                          INA219_CONFIG_MODE_SANDBVOLT_CONTINUOUS;

    // Current_LSB = Maximum Expected Current / 2^15 = (80 / 10) / 2^15 = 0.00002
    // Cal = 0.04096 / (Current_LSB / R) = 0.04096 / (0.0002A * 0.1R) = 20480 = 0x5000
    // Calibration Register = 20480
    ina219_calibrationValue = 20480;

    // 1mA = Current_LSB * bits = 20uA * 50bit (5 bit/mA)
